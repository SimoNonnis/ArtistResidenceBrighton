  ...
  <section>
    ...
    <article class="media-obj u-cf">
      <div class="square media-obj__img">
        <?php if($image_link > ''){ echo '<a target="_blank" href="'. $image_link .'" alt="Click for more">'; } ?>
...
<!-- The Set PopUp -->
<div id="resDiaryPopUpTheSet" class="newsLetter-popup mfp-hide u-margin-auto">
  <iframe frameborder="0" src=http://widget.resdiary.com/(S(kvyckijg4huamc4n0hjusr21))/CheckAvailability.aspx?Id=6588&theme=thesetbrighton allowtransparency="true"style="width: 100%; height: 460px"></iframe>
</div>
<!-- End The Set PopUp -->
